...
function () {
  ...
  _createClass(App, [{
    key: "handleOS",
    value: function handleOS() {
      var osLabel = document.querySelector('.js-os');
      var downloadOrSoon = document.querySelector('.js-download-or-soon');
      ...
      switch (this.os) {
        case 'MacIntel' || 'Mac68K' || 'MacPPC' || 'iPhone' || 'iPad':
          ...
          fetch('https://api.github.com/repos/figma-plus/installer/releases', {
            cache: 'no-cache'
          }).then(function (response) {
            return response.json();
          }).then(function (releases) {
            downloadLink.href = releases[0].assets.find(function (asset) {
    ...
    key: "handleIsChrome",
    value: function handleIsChrome() {
      var chromeButton = document.querySelector('.is-chrome');
      if (!this.isChrome) chromeButton.style.display = 'none';
    }
  }, {
    key: "handleDisabledLinks",
    value: function handleDisabledLinks() {
      var links = document.querySelectorAll('.is-disabled');
    ...
    value: function handleVersion() {
      ...
      fetch('https://api.github.com/repos/figma-plus/figma-plus/releases', {
        cache: 'no-cache'
      }).then(function (response) {
        return response.json();
      }).then(function (releases) {
    ...
    key: "handlePageLoading",
    value: function handlePageLoading() {
      ...
      var logos = document.querySelector('.c-logos'),
          ...
          body = document.body;
      masterTL.to(body, 0.2, {
        opacity: 1
      }).from(figmaLogo, 1, {
        opacity: 0,
        x: -40
      }, 's-logo').from(divider, 1, {
        opacity: 0
      }, 's-logo').from(panelLogo, 1, {
        opacity: 0,
        x: 40
      }, 's-logo').from(logos, 0.5, {
        y: window.innerHeight / 2 - logos.clientHeight - 80,
        delay: 0.5
      });
      masterTL.from(panelShot, 0.5, {
        opacity: 0,
        y: 40,
        scale: 0.95,
      ...
      masterTL.staggerFrom(content.children, 0.5, {
        opacity: 0,
        y: 40
      }, 0.1).from(['header', 'footer'], 1, {
        opacity: 0
      });
    }
  }, {
    key: "handleTeamModal",
    value: function handleTeamModal() {
      var modalsLinks = {
        team: {
          open: '[data-team]',
          node: '.team'
      ...
      Object.keys(modalsLinks).forEach(function (el) {
        var modalOpen = document.querySelector(modalsLinks[el].open),
...
},{"gsap":"../node_modules/gsap/index.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/app.js"], null)
//# sourceMappingURL=/app.f449f9f6.map